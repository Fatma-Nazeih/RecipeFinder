...
// In script.js
function initialize_shared_recipes() {
    if (!localStorage.getItem("sharedRecipes")) {
        set_recipes_to_storage([
            // Your default shared recipes here
        ]);
    }
}
